...
void AnaEff::Loop()
{
	...
	string NameOfFile="MET0405.root";
	string NameOfTxt="AllInfosMET0405.txt";
	string NameOfEff="EffMET0405.txt";
	string EntriesFromZ="EntriesFromZMET0405.txt";
	TString distribvarZ = "DistribZpeakMET0405.root";
