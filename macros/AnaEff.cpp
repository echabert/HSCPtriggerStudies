...
void AnaEff::Loop()
{
	...
	trigEff_selection_obs.LoadNoMap(triggerNames,SubListMET,1,"MET","MET_1025.root"); 
	...
	ofstream InfosData;
	InfosData.open ("AllInfosaod_1025.txt");
	...
	InfosData.close();
	trigEff_selection_obs.Compute("MET1025.txt");
