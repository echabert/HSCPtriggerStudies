...
void CopyTree::CopyWithSelec(string mode){
	...
	string path("/opt/sbg/cms/ui3_data1/dapparu/HSCP/Production/prodMay2021_CMSSW_10_6_2/HSCPppstau_M-1599_TuneZ2star_13TeV_pythia6/MC17_Stau1599/210519_080337/0000/");
	string ext(".root");
