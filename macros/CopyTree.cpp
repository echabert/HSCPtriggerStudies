...
void CopyTree::CopyWithSelec(string mode){
	...
	string path("/opt/sbg/cms/ui3_data1/dapparu/HSCP/Production/prodMay2021_CMSSW_10_6_2/HSCPgluino_M-1600_TuneCP5_13TeV-pythia8/MC17_Gluino1600/210510_161231/0000/");
	string ext(".root");
