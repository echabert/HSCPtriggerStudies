...
void CopyTree::CopyWithSelec(string mode){
	...
	string path("/opt/sbg/cms/ui3_data1/dapparu/HSCP/Production/prodMay2021_CMSSW_10_6_2/HSCPstop_M-2000_TuneCP5_13TeV-pythia8/MC17_Stop2000/210512_084951/0000/");
	string ext(".root");
