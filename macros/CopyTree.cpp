...
void CopyTree::CopyWithSelec(string mode){
	...
	string path("/opt/sbg/cms/ui3_data1/dapparu/HSCP/Production/prodMay2021_CMSSW_10_6_2/HSCPgluino_M_2200_TuneCP5_13TeV_pythia8/MC_MK_Gluino2200/210525_090706/0000/");
	string ext(".root");
