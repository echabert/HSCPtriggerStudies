...
void CopyTree::CopyWithSelec(string mode){
	...
	string path("/opt/sbg/cms/ui3_data1/dapparu/HSCP/Production/prodMay2021_CMSSW_10_6_2/HSCPgluino_M-2000_TuneCP5_13TeV-pythia8/MC_MK_Gluino2000/210525_090629/0000/");
	string ext(".root");
