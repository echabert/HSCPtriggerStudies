...
// used to generate this class and read the Tree.
	if (tree == 0) {
		TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/raph/CMS/HSCPtriggerStudies/first5.root"); 
		if (!f || !f->IsOpen()) {
			f = new TFile("/home/raph/CMS/HSCPtriggerStudies/first5.root"); 
		}
		TDirectory * dir = (TDirectory*)f->Get("/home/raph/CMS/HSCPtriggerStudies/first5.root:/stage"); 
